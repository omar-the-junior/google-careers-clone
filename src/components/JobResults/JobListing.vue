<template>
  <li class="mb-7">
    ...
    >
      ...
      >
        <h2>
          Technical Program Manager, perception,
          augmented reality
        </h2>
        ...
        <div>
          ...
          <div>
            <ul class="list-disc pl-8">
              ...
              <li>
                5 years of experience in program
                management.
              </li>
              <li>
                Experience analyzing data through
                querying database (e.g., SQL)
                using spreadsheet software, and
